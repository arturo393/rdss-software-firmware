...
const Edit = () => {
    ...
    const onSubmit = (e) => {
        ...
        const user = { id: state.user._id, email: state.user.name, company: state.user.company };
    
        axios.post('http://localhost:3000/api/manage/editUser', user)
          .then((result) => {
            ...
            <Card>
                ...
                <Card.Body>
                    ...
                    <Card>
                        ...
                        <Card.Footer>
                            <NextLink href={`/manage/users/managerol/${state.user._id}`}><Button variant="primary" type="button">Manage Rol</Button></NextLink>
                        </Card.Footer>
                    </Card>
                </Card.Body>
            </Card>
