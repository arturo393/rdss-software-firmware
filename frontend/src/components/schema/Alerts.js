    ...
    useEffect(() => {
        ...
        props.monitorData?.map((monitor) => {
            ...
            if (data.connected){
                ...
                setState( prevState => ({
                    alerts: [...prevState.alerts, { id: data.id, connected: a_connected, voltage: a_voltage, current: a_current, gupl: a_agcup, guwl: a_agcdown, power: a_ptx }]
                }));
            }
            else{
                a_connected = red.src;
                            ...
                            { state.alerts?.map((data) => {
                                return (
                                    <tr>
                                        ...
                                        <td><img alt="" src={data.voltage} width={20} height={20} /></td>
                                        <td><img alt="" src={data.current} width={20} height={20} /></td>
                                        <td><img alt="" src={data.gupl} width={20} height={20} /></td>
                                        <td><img alt="" src={data.guwl} width={20} height={20} /></td>
                                        <td><img alt="" src={data.power} width={20} height={20} /></td>
                                    </tr>
                                )
                            }) }
                            </tbody>
